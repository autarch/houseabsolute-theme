...
function houseabsolute_css() {
    ...
    wp_enqueue_style('houseabsolute');
}
add_action( 'wp_enqueue_scripts', 'houseabsolute_css' );
}
...
<p>
<small>Theme based on <a href="http://xtremelysocial.com/wordpress/developer/">Flat Bootstrap Developer Theme by XtremelySocial</a>.
</p>
';
}
